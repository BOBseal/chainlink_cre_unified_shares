...
contract uRWA20Metadata is uRWA20 {
    ...
    function setDocument(bytes32 _name, string memory _uri, bytes32 _documentHash) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function removeDocument(bytes32 _name) public onlyRole(DEFAULT_ADMIN_ROLE){
